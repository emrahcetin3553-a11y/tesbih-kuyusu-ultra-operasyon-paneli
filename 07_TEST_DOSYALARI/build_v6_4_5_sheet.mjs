...
const outputPath = "02_SHEET_SISTEM/Tesbih_Kuyusu_V6_4_5_Ultra_Operasyon_Sheet.xlsx";
const codePath = "03_APPS_SCRIPT_KOD/tesbih_kuyusu_v6_4_5_ultra_operasyon_core.gs";
...
writeTable(workbook, SHEETS.guide, [
  ["TESBİH KUYUSU V6.4.5 ULTRA OPERASYON", ""],
...
function columnPurpose(sheetName, header) {
  ...
  return "V6.4.5 Ultra Operasyon kolon sözleşmesi kapsamında veri alanını taşımak";
}
...
for (const [key, sheetName] of Object.entries(SHEETS)) {
  ...
  HEADERS[key].forEach(header => {
    dictionaryRows.push([
      ...
      isRequired(header),
      "V6.4.5 Ultra Operasyon kolon sözleşmesi"
    ]);
  });
}
