...
const corePath = "03_APPS_SCRIPT_KOD/tesbih_kuyusu_v6_4_3_ultra_operasyon_core.gs";
...
const createCandidate = sandbox.parasutCariOlusturVeyaBagla(ultraGroup[H.INVOICE_GROUP_ID], { mode: "create" });
...
const acceptanceRun = sandbox.v643GercekSheetKabulKontrolu();
assert(!acceptanceRun.ok && acceptanceRun.tekSiparis === 5 && acceptanceRun.topluSiparis === 10, "V6.4.3 kabul akisi sahte OK vermeden veri uretmeli");
...
if (process.env.TK_WRITE_MOCK_STATE === "1") {
  ...
  fs.writeFileSync("07_TEST_DOSYALARI/v6_4_3_mock_sheet_state.json", JSON.stringify(sheetState, null, 2), "utf8");
}
...
console.log(JSON.stringify({
  result: "V6_4_3_ULTRA_OPERASYON_MOCK_OK",
  openId,
