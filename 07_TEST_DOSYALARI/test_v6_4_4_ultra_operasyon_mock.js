...
const corePath = "03_APPS_SCRIPT_KOD/tesbih_kuyusu_v6_4_4_ultra_operasyon_core.gs";
...
const acceptanceRun = sandbox.v644GercekSheetKabulKontrolu();
assert(!acceptanceRun.ok && acceptanceRun.tekSiparis === 5 && acceptanceRun.topluSiparis === 10, "V6.4.4 kabul akisi sahte OK vermeden veri uretmeli");
...
if (process.env.TK_WRITE_MOCK_STATE === "1") {
  ...
  fs.writeFileSync("07_TEST_DOSYALARI/V6_4_4_mock_sheet_state.json", JSON.stringify(sheetState, null, 2), "utf8");
}
