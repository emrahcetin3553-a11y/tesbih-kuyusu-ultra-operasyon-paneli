...
const corePath = "03_APPS_SCRIPT_KOD/tesbih_kuyusu_v6_4_2_ultra_operasyon_core.gs";
...
const acceptanceRun = sandbox.v642GercekSheetKabulKontrolu();
assert(acceptanceRun.ok, "V6.4.2 kabul veri akisi basarisiz");
...
if (process.env.TK_WRITE_MOCK_STATE === "1") {
  ...
  fs.writeFileSync("07_TEST_DOSYALARI/v6_4_2_mock_sheet_state.json", JSON.stringify(sheetState, null, 2), "utf8");
}
