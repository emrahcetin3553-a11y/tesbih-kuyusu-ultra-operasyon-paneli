...
writeTable(workbook, SHEETS.settings, [
  ...
  ["NAVLUNGO_TEST_MODE", "Evet", "İlk Navlungo testlerinde kontrollü alıcı kullanılır", "Evet", "", ""],
  ...
  ["NAVLUNGO_DEFAULT_BARCODE_FORMAT", "pdf", "Varsayılan Navlungo barkod formatı", "Evet", "", ""],
