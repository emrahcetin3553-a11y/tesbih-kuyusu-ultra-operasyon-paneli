...
writeTable(workbook, SHEETS.settings, [
  ...
  ["NAVLUNGO_CARRIER_ID_MAP_JSON", "{\"Aras Kargo\":\"1\",\"Yurtiçi Kargo\":\"2\"}", "Kargo firması -> Navlungo carrier_id map JSON", "Evet", "", "Kargo firması varsa map eşleşmesi zorunludur"],
