/**
 * Tesbih Kuyusu V6.4.4 - Ultra Operasyon Core
 *
...
var TK6 = (function () {
  ...
  function v644GercekSheetKabulKontrolu_() {
    var started = Date.now();
    var ss = SpreadsheetApp.getActiveSpreadsheet();
    sistemKolonlariniHazirla_();
    var payloads = v644KabulPayloadlari_();
    var tekSonuclar = [];
    ...
    var ozet = v644KabulSayimOzeti_(ss);
    return {
      ...
      salesPost: "Yapılmadı",
      counts: ozet,
      status: "V6.4.4 gerçek Sheet kabul veri akışı tamamlandı"
    };
  }

  function v644KabulSayimOzeti_(ss) {
    return {
  ...
  function v644KabulPayloadlari_() {
  ...
  return {
    ...
    v644GercekSheetKabulKontrolu: v644GercekSheetKabulKontrolu_,
    HEADERS: HEADERS,
    H: H,
    CFG: CFG
  };
...
function v644GercekSheetKabulKontrolu() { return TK6.v644GercekSheetKabulKontrolu(); }
