/**
 * Tesbih Kuyusu V6.4.2 - Ultra Operasyon Core
 *
...
var TK6 = (function () {
  ...
  function v641GercekSheetKabulKontrolu_() {
    var started = Date.now();
    var ss = SpreadsheetApp.getActiveSpreadsheet();
    sistemKolonlariniHazirla_();
    var payloads = v641KabulPayloadlari_();
    var tekSonuclar = [];
    ...
    var ozet = v641KabulSayimOzeti_(ss);
    return {
      ...
      salesPost: "Yapılmadı",
      counts: ozet,
      status: "V6.4.2 gerçek Sheet kabul veri akışı tamamlandı"
    };
  }

  function v642GercekSheetKabulKontrolu_() {
    return v641GercekSheetKabulKontrolu_();
  }

  function v641KabulSayimOzeti_(ss) {
    return {
  ...
  function v641KabulPayloadlari_() {
  ...
  return {
    ...
    v641GercekSheetKabulKontrolu: v641GercekSheetKabulKontrolu_,
    v642GercekSheetKabulKontrolu: v642GercekSheetKabulKontrolu_,
    HEADERS: HEADERS,
    H: H,
    CFG: CFG
  };
...
function v641GercekSheetKabulKontrolu() { return TK6.v641GercekSheetKabulKontrolu(); }
function v642GercekSheetKabulKontrolu() { return TK6.v642GercekSheetKabulKontrolu(); }
